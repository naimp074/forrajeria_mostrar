...
export default function Fiados() {
  return (
    <div className="space-y-6 sm:space-y-8">
      <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold tracking-tight">Fiados</h1>
      <p className="text-slate-600 -mt-2 sm:-mt-4 text-sm sm:text-base">
        Deudas pendientes y registro de pagos.
      </p>
      <section className="rounded-2xl sm:rounded-[28px] bg-white border border-slate-200 shadow-lg overflow-hidden">
        <div className="px-4 sm:px-6 py-4 sm:py-5 border-b border-slate-200">
          <h2 className="text-xl sm:text-2xl font-bold">Cuentas por cobrar</h2>
        ...
        <div className="p-4 sm:p-6 space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2">
            <button className="rounded-2xl border border-slate-300 bg-white py-3 font-semibold text-sm sm:text-base touch-manipulation">
              Ver historial
            </button>
            <button className="rounded-2xl bg-amber-500 text-white py-3 font-semibold text-sm sm:text-base touch-manipulation">
              Registrar pago
            </button>
          </div>
        </div>
